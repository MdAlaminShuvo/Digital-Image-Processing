...
def main():
    ...
    kernel2 = np.ones(( 3, 3), dtype = np.float32) * 2 / 7
    kernel3 = np.array([[-1, -1, 0], [-1, 1, 0], [4, -2, 0]])
    kernel4 = np.array([[0, -1, 1], [-1, 4, -1], [0, -1, 0]])
    kernel5 = np.array([[-1, 0, -1], [0, 8, 0], [-1, 0, -1]])
    kernel6 = np.array([[3, 4, 5], [0, 0, 0], [-3, -4, -5]])
